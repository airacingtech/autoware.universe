  ...
  z_(object.kinematics.pose_with_covariance.pose.position.z)
{
  ...
  float r_stddev_vx = 10.0;                                    // object coordinate [m/s]
  float p0_stddev_x = 10.0;                                    // object coordinate [m/s]
  float p0_stddev_y = 1.0;                                    // object coordinate [m/s]
  float p0_stddev_yaw = tier4_autoware_utils::deg2rad(10);    // map coordinate [rad]
  float p0_stddev_vx = tier4_autoware_utils::kmph2mps(40);  // object coordinate [m/s]
